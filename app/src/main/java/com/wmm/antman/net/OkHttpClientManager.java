...
/**
 * Created by wangmingming on 2015/10/13.
 */
public class OkHttpClientManager {
     ...
     * @return 字符串
     */
    private void _getAsString(String url, final StringCallback callback, Map<String, String> param) throws IOException {
        final Request request = new Request.Builder()
                .url(getParams(url, param))
                .build();
        Log.d("HttpUrl", request.toString());
...
//    }
    ...
    public static void getAsString(String url, StringCallback callback, Map<String, String> param) throws IOException {
//        return getInstance()._getAsString(url,callback,param);
        getInstance()._getAsString(url, callback, param);
    }
